                ...
                <ul class="nav navbar-nav">
                  ...
                  <li class="dropdown user-menu">
                    <button href="#" class="dropdown-toggle nav-link" data-toggle="dropdown">
                      <img 
                      src="{{Auth::user()->profile_photo_url ? Auth::user()->profile_photo_url : 
                        asset('backend/assets/img/user/user.png') }}"
                    ...
                    <ul class="dropdown-menu dropdown-menu-right">
                      ...
                      <li class="dropdown-header">
                        <img src="{{Auth::user()->profile_photo_url ? Auth::user()->profile_photo_url : 
                          asset('backend/assets/img/user/user.png') }}"
                      ...
                      <li>
                        <a href="{{route('update.user.profile')}}">
